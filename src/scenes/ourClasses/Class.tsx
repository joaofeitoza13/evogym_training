...
const Class = ({ name, description, image }: IClass) => {
  ...
  return (
    <li className="relative mx-5 inline-block h-[380px] w-[450px]">
      <div className="rounded-md absolute z-30 flex h-[79%] w-[450px] flex-col items-center justify-center whitespace-normal bg-secondary-400 p-5 text-center text-black opacity-0 transition duration-500 hover:opacity-90">
